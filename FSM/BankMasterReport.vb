...
Public Class BankMasterReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FSM.BankMasterReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBankMasterReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BankMasterReport = New BankMasterReport
        rpt.Site = Me.Site
        Return rpt
    End Function
