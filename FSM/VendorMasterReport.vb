...
Public Class VendorMasterReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FSM.VendorMasterReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVendorMasterReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VendorMasterReport = New VendorMasterReport
        rpt.Site = Me.Site
        Return rpt
    End Function
